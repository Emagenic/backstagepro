...
<body>
	<header>
		<div id="banner">
			<div id="headerimgs">
				...
				<figure id="imagencentroslide">
					<img src="imagenes/slide.png">
				</figure>
			</div>
		</div>
	</header>
	<article id="contenedor_bienvenidos">
		<figure id="foto_bienvenidos">
			<img src="imagenes/bienvenidos.jpg"  width='342' height='342' title='bienvenidos'>
		</figure>
		<h1>PRODUCCION DE EVENTOS</h1>
